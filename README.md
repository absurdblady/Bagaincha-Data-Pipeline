...
1. load the dataset
2. inspect missing or inconsistent values
3. clean and standardize all fields
4. 4.build the variables that actually carry information
5. generate a processed output that I can rely on
...
1. what part of the dataset was processed
2. what transformations were applied
3. what information is now available inside it
